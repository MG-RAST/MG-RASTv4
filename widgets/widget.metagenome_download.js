(function() {
    ...
    widget.display = function(wparams) {
        ...
        if (Retina.cgiParam('metagenome')) {
            ...
            var table = Retina.Renderer.create("table", {
                target: document.getElementById('projects_table'),
                data: {},
            ...
            table.settings.invisible_columns = {
                0: true
            };
            ...
            table.settings.asynch_column_mapping = {
                "Project ID": "id",
                "Project": "name",
                "Contact": "pi",
                "status": "status",
    ...
    widget.displayMetagenomeDownloads = function() {
        ...
        jQuery("#downloadhelp").popover({
            "html": true,
            "trigger": "hover",
            "placement": "left",
            "title": "<b>Download Column Fields</b>",
            "content": "<ol>\
