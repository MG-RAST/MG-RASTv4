(function () {
	...
	var options = { "fastq": [ { "name": "assembled",
					 ...
					 "class": "checkbox",
					 "checked": false,
					 "text": 'Select this option if your input sequence file(s) contain assembled data and include the coverage information within each sequence header as described <a target="blank" href="http://help.mg-rast.org/user_manual.html">here</a>.' } ] },
				   { "name": "dereplication",
				     "fields": [
					 { "id": "dereplication",
					   "name": "dereplication",
