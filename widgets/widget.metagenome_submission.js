(function () {
	...
	if (md_file_opts.length) {
	    ...
	    md_file_opts = '<p>You do not have any metadata files available. Metadata can be uploaded on the <a href="?mgpage=upload">upload page</a>.</p><p>If you have uploaded metadata and it is not displayed here, it might be invalid. Click on the metadata file in your inbox on the <a href="?mgpage=upload">upload page</a> to receive more information.</p><p>Submission of multiple files, sharing of data or data publication require metadata. You can use <a href="'+RetinaConfig.mgrast_ftp+'/data/misc/metadata/MGRAST_MetaData_template_1.9.xlsx">this Excel template</a> and/or <a href="?mgpage=metazen2" target="_blank">the MetaZen tool</a> to fill out the metadata spreadsheet for a study.</p><p>More information about metadata can be found in the <a href="'+RetinaConfig.mgrast_ftp+'/data/manual/mg-rast-manual.pdf#page=28" target=_blank>MG-RAST manual, section 2.7</a>.</p>';
	}
	...
	var options = { "fastq": [ { "name": "assembled",
					 ...
					 "class": "checkbox",
					 "checked": false,
					 "text": 'Select this option if your input sequence file(s) contain assembled data and include the coverage information within each sequence header as described <a target="blank" href="'+RetinaConfig.mgrast_ftp+'/data/manual/mg-rast-manual.pdf#98">here</a>.' } ] },
				   { "name": "dereplication",
				     "fields": [
					 { "id": "dereplication",
					   "name": "dereplication",
