...
<form class="form-horizontal">\
  ...
  <div class="control-group">\
    ...
    <div class="controls"></span>\
      <input type="text" id="inputLastname" placeholder="lastname" class="span4" onblur="Retina.WidgetInstances.metagenome_register[1].checkNotEmpty(this);">please Note: initials are not acceptable\
    </div>\
  </div>\
  <div class="control-group">\
    <label class="control-label" for="inputLogin">Login</label>\
