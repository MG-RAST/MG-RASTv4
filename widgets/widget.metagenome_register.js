(function () {
	...
	widget.sidebar.innerHTML = "<h3><img style='height: 20px; margin-right: 10px; margin-top: -4px;' src='Retina/images/info.png'>Password Reset fails?</h3><p>If you are trying to reset your password, but you do not remember the login, you can request your login by submitting the email address only.</p>";
...
<div id="recap"></div>\
  <button type="button" class="btn" onclick="Retina.WidgetInstances.metagenome_register[1].performPasswordReset();" id="submit">reset password / retrieve login</button>\
</form>\
';
...
<form class="form-horizontal">\
  <div class="control-group">\
    ...
    <div class="controls" align="left">\
      <input type="text" id="inputFirstname" placeholder="firstname" class="span4" onblur="Retina.WidgetInstances.metagenome_register[1].checkNotEmpty(this);"><span class="help-inline" id="namecheck">please Note: initials are not acceptable</span>\
    </div>\
  </div>\
  <div class="control-group">\
    <label class="control-label" for="inputLastname">Last Name</label>\
    <div class="controls">\
      <input type="text" id="inputLastname" placeholder="lastname"  onblur="Retina.WidgetInstances.metagenome_register[1].checkNotEmpty(this);" class="span4"><span class="help-inline" >please Note: initials are not acceptable </span>\
    </div>\
  </div>\
  <div class="control-group">\
    <label class="control-label" for="inputLogin">Login</label>\
...
';
    ...
    widget.organizations = [ ["Wellcome Trust Sanger Institute", "Sanger", "http://www.sanger.ac.uk/"],
			     ...
			     ["Blaise Pascal University (Universit� Blaise Pascal, Clermont-Ferrand II)", "UBP", "http://www.univ-bpclermont.fr/"],
			     ...
			     ["University of T�bingen", "University of Tuebingen", "http://www.uni-tuebingen.de"],
			     ...
			     ["Instituto Nacional de T�cnica Aeroespacial", "INTA", "http://www.inta.es/"],
			     ...
			     ["Universidade Federal de S�o Carlos", "UFSCar", "http://www2.ufscar.br/home/index.php"],
			     ...
			     ["National Autonomous University of Mexico (Universidad Nacional Aut�noma de M�xico)", "UNAM", "http://www.unam.mx/"],
			     ["University of Queensland", "UQ", "http://www.uq.edu.au/"],
			     ["Universit� Libre de Bruxelles", "ULB", "http://www.ulb.ac.be/"],
			     ...
			     ["Institute of Molecular and Cell Biology of Rosario (Instituto de Biolog�a Molecular y Celular de Rosario)", "IBR", "http://www.ibr.gov.ar/"],
			     ...
			     ["University of Vienna (Universit�t Wien)", "NULL", "http://www.univie.ac.at/"],
			     ["United States Air Force", "USAF", "http://www.af.mil/"],
			     ["Universidad P�blica de Navarra", "UPNA", "http://www.unavarra.es/"],
			     ...
			     ["Universit� Laval", "Laval", "http://www.ulaval.ca/"],
			     ...
			     ["Universidade Cat�lica Portuguesa", "UCP", "http://www.ucp.pt/"],
			     ["Harvard University", "Harvard", "http://www.harvard.edu/"],
			     ["Xiamen University ", "XMU", "http://www.xmu.edu.cn/"],
			     ["University of Concepci�n (Universidad de Concepci�n)", "UdeC", "http://www.udec.cl/"],
			     ...
			     ["Universidade Federal do Paran�", "UFPR", "http://www.ufpr.br/"],
			     ...
			     ["Fundaci�n Ciencia Para La Vida", "FCV", "http://www.cienciavida.cl/"],
			     ["Kinki University", "NULL", "http://ccpc01.cc.kindai.ac.jp/"],
			     ["Instituto Mediterr�neo de Estudios Avanzados", "IMEDEA", "http://www.imedea.uib.es/"],
			     ...
			     ["Laboratoire de Microbiologie et G�n�tique Mol�culaires", "LMGM", "http://www-lmgm.biotoul.fr/"],
			     ...
			     ["Julius K�hn-Institut", "JKI", "http://www.jki.bund.de/"],
			     ["University of G�ttingen", "NULL", "http://www.uni-goettingen.de/"],
			     ...
			     ["Centro Nacional de Investigaciones Oncol�gicas", "CNIO", "http://www.cnio.es/"],
			     ...
			     ["Consejo Nacional de Investigaciones Cient�ficas y T�cnicas", "CONICET", "http://www.conicet.gov.ar/"],
			     ...
			     ["�cole centrale de Lyon", "EC-Lyon", "http://www.ec-lyon.fr/"],
			     ...
			     ["Ruhr-Universit�t Bochum", "RUB", "http://www.ruhr-uni-bochum.de/"],
			     ["Universit� Claude Bernard Lyon 1", "UCBL1", "http://www.univ-lyon1.fr/"],
			     ["Centro Superior de Investigaci�n en Salud P�blica", "CSISP", "http://www.csisp.gva.es/"],
			     ["Centro Nacional de Biotecnolog�a", "CNB", "http://www.cnb.csic.es/"],
			     ["Freie Universit�t Berlin", "FU", "http://www.fu-berlin.de/"],
			     ...
			     ["Universidade de S�o Paulo", "USP", "http://www.usp.br/"],
			     ...
			     ["Laborat�rio Nacional de Computa��o Cient�fica", "LNCC", "http://www.lncc.br/"],
			     ...
			     ["Instituto de Tecnologia Qu�mica e Biol�gica", "ITQB", "http://www.itqb.unl.pt/"],
			     ...
			     ["Commissariat � l Energie Atomique", "CEA", "http://www.cea.fr/"],
			     ...
			     ["Universit� de Montr�al", "UdeM", "http://www.umontreal.ca/"],
			     ...
			     ["Estaci�n Experimental del Zaid�n", "EEZ-CSIC", "http://www.eez.csic.es/"],
			     ["Centro Regional de Estudios Gen�micos", "CREG", "http://www.creg.org.ar/"],
			     ["Molecular Biology Center Severo Ochoa (Centro de Biolog�a Molecular Severo Ochoa)", "CBMSO", "http://www.cbm.csic.es/"],
			     ...
			     ["Universidade Federal de S�o Paulo", "UNIFESP", "http://www.unifesp.br/"],
			     ["Institut de recherche pour le d�veloppement", "IRD", "http://www.ird.fr/"],
			     ["�cole normale sup�rieure de Lyon", "ENS Lyon", "http://www.ens-lyon.fr/"],
			     ...
			     ["Centro de Investiga��o em Biodiversidade e Recursos Gen�ticos", "CIBIO", "http://cibio.up.pt/"],
			     ...
			     ["Charit� - Universit�tsmedizin Berlin", "NULL", "http://www.charite.de/"],
			     ...
			     ["Friedrich-Schiller-Universit�t Jena", "FSU", "http://www.uni-jena.de/"],
			     ...
			     ["Centro de Investigaciones Biol�gicas", "CIB", "http://www.cib.csic.es/"],
			     ...
			     ["Catholic University of the North (Universidad Cat�lica del Norte)", "UCN", "http://www.ucn.cl/"],
			     ...
			     ["Universit� Montpellier 2", "um2", "http://www.univ-montp2.fr/"],
			     ...
			     ["University of Western Brittany (Universit� de Bretagne Occidentale)", "UBO", "http://www.univ-brest.fr/"],
			     ["University of Pennsylvania", "Penn", "http://www.upenn.edu/"],
			     ["Universit� de Caen Basse-Normandie", "NULL", "http://www.unicaen.fr/"],
			     ["New Mexico Institute of Mining and Technology", "NMT", "http://www.nmt.edu/"],
			     ["L'Universit� de Pau et des Pays de l'Adour", "UPPA", "http://www.univ-pau.fr/"],
			     ...
			     ["University of the Azores (Universidade dos A�ores)", "UAC", "http://www.uac.pt/"],
			     ...
			     ["University of Padua (Universit� degli Studi di Padova)", "UNIPD", "http://www.unipd.it/"],
			     ["Rush University", "RushU", "http://www.rushu.rush.edu/"],
			     ["University of Kiel (Christian-Albrechts-Universit�t zu Kiel)", "CAU", "http://www.uni-kiel.de/"],
			     ...
			     ["Universidad Tecnol�gica de Pereira", "UTP", "http://www.utp.edu.co/"],
			     ...
			     ["Universidade Cat�lica de Bras�lia", "UCB", "http://www.ucb.br/"],
			     ...
			     ["S�o Paulo State University (Universidade Estadual Paulista)", "UNESP", "http://www.unesp.br/"],
			     ["Laboratorio de Investigaciones Microbiol�gicas de Lagunas Andinas", "NULL", "NULL"],
			     ["Universidade Federal do Rio Grande do Norte", "UFRN", "http://www.ufrn.br/"],
			     ["Universidade Federal do Cear�", "UFC", "http://www.ufc.br/"],
			     ...
			     ["Centro de Investigaci�n en Alimentaci�n y Desarrollo A.C.", "CIAD", "http://www.ciad.mx/"],
			     ["Xplorigen Technologies", "XTPL", "http://ai.xplorigen.com/XTPL/"],
			     ["Universidade da Coru�a", "NULL", "http://www.udc.es/"],
			     ...
			     ["Helmholtz Zentrum M�nchen", "NULL", "http://www.helmholtz-muenchen.de/"],
			     ...
			     ["University of Li�ge", "ULg", "http://www.ulg.ac.be/"],
			     ...
			     ["Leibniz Institute for Natural Product Research and Infection Biology, Hans-Kn�ll-Institute (HKI)", "HKI", "http://www.hki-jena.de/"],
			     ...
			     ["Universit� Cattolica del Sacro Cuore", "UCSC", "http://www.unicattolica.it/"],
			     ...
			     ["Instituto de Cat�lisis y Petroleoqu�mica", "ICP", "http://www.icp.csic.es/"],
			     ["Centro de Estudios Cient�ficos", "CECS", "http://www.cecs.cl/"],
			     ...
			     ["Johann Heinrich von Th�nen-Institut", "vTI", "http://www.vti.bund.de/"],
			     ...
			     ["CIRAD, Centre de coop�ration internationale en recherche agronomique pour le d�veloppement", "CIRAD", "http://www.cirad.fr/"],
			     ...
			     ["Instituto Nacional dos Recursos Biol�gicos", "NULL", "NULL"],
			     ...
			     ["E�tv�s Lor�nd University", "ELTE", "http://www.elte.hu/"],
			     ...
			     ["Consejo Superior de Investigaciones Cient�ficas", "CSIC", "http://www.csic.es/"],
			     ...
			     ["�cole Polytechnique F�d�rale de Lausanne", "EPFL", "http://www.epfl.ch/"],
			     ["paul", "NULL", "NULL"],
			     ...
			     ["Universidad Michoacana de San Nicol�s de Hidalgo", "UMSNH", "http://www.umich.mx/"],
			     ...
			     ["Agroscope Changins-W�denswil", "ACW", "http://www.agroscope.admin.ch/"],
			     ...
			     ["Centro de Excel�ncia em Bioinform�tica de Minas Gerais", "CEBio", "http://cebio.org/"],
			     ["Southern Medical University", "SMU", "http://www.smu.com/"],
			     ["Florida A&M University", "NULL", "NULL"],
			     ["Observatoire Oc�anologique de Banyuls sur mer", "OBS", "http://www.obs-banyuls.fr/"],
			     ...
			     ["Universidade do Vale do Itaja�", "Univali", "http://www.univali.br/"],
			     ...
			     ["Instituto de Investigaciones Biol�gicas Clemente Estable", "IIBCE", "http://www.iibce.edu.uy/"],
			     ...
			     ["Nestl� S.A.", "Nestl�", "http://www.nestle.com/"],
			     ...
			     ["University of the Philippines Los Ba�os", "UPLB", "http://www.uplb.edu.ph/"],
			     ...
			     ["Hospital Heli�polis", "NULL", "http://www.heliopolis.org.br/"],
			     ...
			     ["Instituto de Productos L�cteos de Asturias", "IPLA-CSIC", "http://www.ipla.csic.es/"],
			     ["Laborat�rio Nacional de Ci�ncia e Tecnologia do Bioetanol", "CTBE", "http://www.bioetanol.org.br/"],
			     ["Academic Medical Center", "AMC", "http://www.amc.nl/"],
			     ["Charles University in Prague", "Charles University", "http://www.cuni.cz/"],
			     ["Institut F�d�ratif de Recherche 48", "IFR48", "http://www.ifr48.com/"],
			     ["Ewha Womans University", "Ewha", "http://www.ewha.ac.kr/"],
			     ["University of Wisconsin Oshkosh", "UW Oshkosh", "http://www.uwosh.edu/"],
			     ["Laborat�rio Nacional de Bioci�ncias", "LNBio", "http://www.lnbio.org.br/"],
			     ["University of Malaya", "UM", "http://www.um.edu.my/"],
			     ["Institut de Recherche en Informatique et Syst�mes Al�atoires", "IRISA", "http://www.irisa.fr/"],
			     ...
			     ["University of Perugia (Universit� degli Studi di Perugia)", "NULL", "http://www.unipg.it/"],
			     ...
			     ["University of the Basque Country (Universidad del Pa�s Vasco)", "EHU", "http://www.ehu.es/"],
			     ["Novartis Institutes for BioMedical Research", "NIBR", "http://www.nibr.com/"],
			     ["Institut National des Sciences Appliqu�es de Lyon", "INSA de Lyon", "http://www.insa-lyon.fr/"],
			     ["Institut national de la sant� et de la recherche m�dicale", "Inserm", "http://www.inserm.fr/"],
			     ...
			     ["Centre for Genomic Regulation (Centre de Regulaci� Gen�mica)", "CRG", "http://pasteur.crg.es/"],
			     ...
			     ["University of Innsbruck  (Leopold-Franzens-Universit�t Innsbruck)", "NULL", "http://www.uibk.ac.at/"],
			     ...
			     ["University of Rostock (Universit�t Rostock)", "Rostock", "http://www.uni-rostock.de/"],
			     ...
			     ["Yucatan Center for Scientific Research (Centro de Investigaci�n Cient�fica de Yucat�n, A.C.)", "CICY", "http://www.cicy.mx/"],
			     ["Norwegian University of Life Sciences  (Universitetet for milj�- og biovitenskap)", "UMB", "http://www.umb.no/"],
			     ...
			     ["University of Quebec at Rimouski  (Universit� du Qu�bec � Rimouski)", "UQAR", "http://www.uqar.ca/"],
			     ["Deakin University", "Deakin", "http://www.deakin.edu.au/"],
			     ["Autonomous University of Nuevo Le�n (Universidad Aut�noma de Nuevo Le�n)", "UANL", "http://www.uanl.mx/"],
			     ["Genomatix Software GmbH", "Genomatix", "http://www.genomatix.de/"],
			     ["Aix-Marseille University  (Universit� d", "NULL", "http://www.univ-amu.fr/"],
			     ...
			     ["Versailles Saint-Quentin-en-Yvelines University (Universit� de Versailles Saint-Quentin-en-Yvelines)", "UVSQ", "http://www.uvsq.fr/"],
			     ["Williams College", "Williams", "http://www.williams.edu/"],
			     ["University of Auvergne (Universit� d", "NULL", "http://www.u-clermont1.fr/"],
			     ...
			     ["Autonomous University of Barcelona (Universitat Aut�noma de Barcelona)", "UAB", "http://www.uab.cat/"],
			     ...
			     ["Universit�tsklinikum Erlangen", "NULL", "http://www.uk-erlangen.de/"],
			     ...
			     ["Instituto Tecnol�gico Superior de Irapuato", "ITESI", "http://www.itesi.edu.mx/"],
			     ["Illumina", "Illumina", "http://www.illumina.com/"],
			     ["University of Auckland", "NULL", "http://www.auckland.ac.nz/"],
			     ["Federal University of Para�ba", "UFPB", "http://www.ufpb.br/"],
			     ...
			     ["Universidade Federal de Vi�osa", "UFV", "http://www.ufv.br/"],
			     ...
			     ["Centre Nacional d'Anàlisi Genòmica", "CNAG", "http://www.cnag.cat/"],
			     ...
			     ["Fondation M�rieux", "NULL", "http://www.fondation-merieux.org/"],
			     ...
			     ["Autonomous University of Yucatan (Universidad Aut�noma de Yucat�n)", "UADY", "http://www.uady.mx/"],
			     ...
			     ["University of Neuch�tel (Universit� de Neuch�tel)", "UniNE", "http://www.unine.ch/"],
			     ...
			     ["Atat�rk University", "NULL", "http://www.atauni.edu.tr/"],
			     ...
			     ["Bay Zolt�n Nonprofit Ltd. for Applied Research", "bay", "http://www.bayzoltan.hu/"],
			     ...
			     ["Institute for Veterinary Medical Research", "MTA ATK �OTI", "http://www.vmri.hu/"],
			     ...
			     ["Centro de Astrobiolog�a", "CAB", "http://cab.inta-csic.es/"],
			     ...
			     ["Universidade Federal de Ci�ncias da Sa�de de Porto Alegre", "UFCSPA", "http://www.ufcspa.edu.br/"],
