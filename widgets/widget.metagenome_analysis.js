  ...
  <div class="tab-pane'+(cat == 'env_package' ? ' active' : "")+'" id="env_package">env_package</div>\
    ...
    */
	...
	if (! widget.hasOwnProperty('mgselect')) {
	    ...
	    var specialFilters = [ { "attribute": "sequence_type", "title": "sequence type", "type": "radio", "options": [ { "value": "all", "title": "all", "checked": true }, { "value": "wgs", "title": "shotgun", "checked": false }, { "value": "amplicon", "title": "amplicon", "checked": false }, { "value": "Barcode", "title": "barcode", "checked": false }, { "value": "mt", "title": "metatranscriptome", "checked": false } ] }, { "attribute": "retry", "title": "reload<sup title='WARNING: the reload of a profile can take some time' style='cursor: help;'>[?]</sup>", "type": "checkbox", "isOption": true, "options": [ { "value": "1", "title": " ", "checked": false } ] } ];
	    if (stm.user) {
