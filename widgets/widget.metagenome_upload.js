(function () {
	...
	sidehtml += '<dt>'+widget.expander()+'File Formats</dt><dd style="display: none;">You can upload any fasta, fastq, or SFF files. For metadata please use <a href="https://github.com/MG-RAST/MG-RASTv4/raw/master/data/MGRAST_MetaData_template_current.xlsx">MS Excel spreadsheets</a> with GSC MIxS-compliant metadata. (Check our <a href="?mgpage=metazen2" target=_blank>Metazen tool</a> for assistance in creating and filling them out). If you want to upload multiple files at a time, you need to place them into an archive (e.g., tar or zip).<br><br></dd>';
