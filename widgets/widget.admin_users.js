(function () {
	...
	if (data && data.length) {
		...
		html += "<tr><td>"+data[i].firstname+"</td><td>"+data[i].lastname+"</td><td>"+data[i].login+"</td><td>"+data[i].email+"</td><td>"+data[i].entry_date+"</td><td style='text-align: center;'><input type='radio' name='requestaction_"+data[i].login+"' id='requestaction_accept_"+data[i].login+"' checked></td><td style='text-align: center;'><input type='radio' name='requestaction_"+data[i].login+"' id='requestaction_deny_"+data[i].login+"'></td><td style='text-align: center;'><input type='radio' name='requestaction_"+data[i].login+"' id='requestaction_defer_"+data[i].login+"' ></td></tr>";
	    }
	    html += "</table>";
	} else {
