(function () {
	...
	var notebook = Retina.Renderer.create('notebook', { target: container, showTOC: false, tocTarget: sidebar, editTarget: sidebar, flow: stm.DataStore.flows.metagenome_overview, dataContainer: stm.DataStore.metagenome[widget.id], editMode: true }).render();	
    };  
