function initWebApp () {
	...
	Retina.load_widget({"name": "login", "resource": "Retina/widgets"}).then( function() {
	    ...
	    Retina.Widget.create('login', { "target": document.getElementById("login_space"),
						...
						{ "title": "<img src='Retina/images/file-pdf.png' style='width: 16px; position: relative; bottom: 1px; margin-right: 5px;'> handbook", "url": "ftp://ftp.mg-rast.org/data/manual/mg-rast-manual.pdf" },
